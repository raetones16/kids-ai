  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Update the 6-digit PIN used to access the parent dashboard</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This PIN is required to access the parent dashboard from the child selection screen.
        ...
        <CardContent>
          {error && (
            <div className="flex items-start gap-2 p-3 mb-4 bg-red-50 text-red-800 rounded-md border border-red-200">
          ...
          {success && (
            <div className="flex items-start gap-2 p-3 mb-4 bg-green-50 text-green-800 rounded-md border border-green-200">
      ...
      <div className="bg-amber-50 border border-amber-200 p-4 rounded-md">
        <p className="text-amber-800 text-sm">
          <strong>Important:</strong> Remember your PIN. If you forget it, you'll need to reset the application to regain access to the parent dashboard.
        </p>
      </div>
    </div>
  );
